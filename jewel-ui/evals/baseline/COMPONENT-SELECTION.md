...
1. Sentence-style capitalization.
...
Source: [Radio Button](https://plugins.jetbrains.com/docs/intellij/radio-button.html), [Checkbox](https://plugins.jetbrains.com/docs/intellij/checkbox.html).
